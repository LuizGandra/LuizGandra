...
<p>Sou um **Web Developer** e **UI/UX Designer** focado em criar interfaces intuitivas e práticas que solucionem problemas reais de forma eficiente, prezando pela acessibilidade, performance e experiência do usuário. Atualmente cursando o **common-core** da [https://www.42sp.org.br/](42SP), possuo experiência sólida com **React (Next.js e Vite)**, **CSS (Tailwind)**, **Node.js** e **HTML**.</p>
